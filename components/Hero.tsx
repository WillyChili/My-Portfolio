  ...
  return (
    <main
      style={{
        ...
        paddingTop: "calc(52px + clamp(1.5rem, 4vw, 3rem))",
        paddingBottom: "calc(clamp(1.5rem, 4vw, 3rem) + 5rem)",
        position: "relative",
        background: "#171717",
      }}
    >
      ...
      {/* Bottom fade — dots dissolve into background */}
      <div
        style={{
          position: "absolute",
          bottom: 0,
      ...
      {/* Copy + companies grouped and centered */}
      <div
        style={{
          display: "flex",
          flexDirection: "column",
      ...
      >
        ...
        >
          {[
            { src: "/upwork.png", alt: "Upwork", href: "https://www.upwork.com/freelancers/~010a617462fe6d7f5e", width: "160px", height: "72px" },
            { src: "/traditum.png", alt: "Traditum", href: "https://institucional.traditum.com/", width: "280px", height: "72px" },
            { src: "/concntric.svg", alt: "ConCntric", href: "https://concntric.com/", width: "179px", height: "46px" },
            { src: "/coderhouse.png", alt: "Coderhouse", href: "https://www.coderhouse.com/ar/", width: "280px", height: "72px" },
