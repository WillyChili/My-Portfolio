export default function EchoCover() {
  return (
    ...
    >
      {/* Everything below scales together as one unit, so the glow/grid
          shrink and re-center along with the phone instead of the phone
          floating alone in an unchanged background. */}
